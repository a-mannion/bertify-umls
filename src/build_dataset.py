...
def main(args: Namespace, logger: logging.Logger) -> None:
    ...
    if monolingual:
        ...
        subdir_stem = "multi_v"
    if args.existing_subdir is None:
        datagen_version = 0
        ...
        write_dir = os.path.join(args.writepath, subdir_stem + str(args.existing_subdir))
        assert os.path.isdir(write_dir), f"{write_dir} not found"
